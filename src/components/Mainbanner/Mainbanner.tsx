...
const Mainbanner: React.FC = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 h-screen gap-0">
      ...
      <div className="grid-item-2 lg:col-span-2  flex flex-col items-start">
        <img src={mainpic2} alt="" />
        <div className="description text-left flex flex-col ml-5 lg:ml-14">
        <h1 className="text-black text-3xl mt-10 mb-5">Erlebe deine Kaffeeroutine jetzt <br/> anders!</h1>
