...
const Card2 = () => {
  return (
    <div className="grid grid-cols-1 grid-rows-3 md:grid-rows-2 ">
      ...
      <div className="card-content-descirption row-span-1 mx-5 flex gap-1 flex-col justify-center">
        ...
        <button className="border-[#00704A] border-2 w-1/4 rounded-xl text-[#00704A] px-2 lg:px-0 py-1 font-semibold text-sm cursor-pointer hover:bg-[#00704A]/20">Jetzt bestellen</button>
      </div>
    </div>
  )
}
